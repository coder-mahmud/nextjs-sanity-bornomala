...
import ModalRoot from "./others/ModalRoot"
...
const ImageOverlay = ({text,imageUrl}:{text:string, imageUrl:string}) => {
  ...
  return (
    <div className="">
      ...
      { showOverlay && <ModalRoot open={true}>
        <div className={` fixed  w-full h-full left-0 top-0  bg-gray-500 z-20 flex items-center justify-center`}>
