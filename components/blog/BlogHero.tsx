...
const BlogHero = async () => {
  ...
  const blogPageImage = siteOptions?.blogPageImage?.node?.sourceUrl




  return (
    <section data-aos="fade-up" data-aos-offset="0" data-aos-duration="1000" data-aos-delay="0"  className='bg-cover bg-center bg-no-repeat ' style={{ backgroundImage: `url(${blogPageImage})` }}>
